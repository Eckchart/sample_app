...
class UsersIndexAdminTest < UsersIndexAdmin
  ...
  test "should display only activated users" do
    ...
    # Making an unactivated fixture user isn't sufficient because
    ...
    # `assigns(:users)` does return the paginated users in the first
    # page (since we don't specify a page, so it defaults to the first page).
